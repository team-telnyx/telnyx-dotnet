...
namespace TelnyxTests.Services.Calls.CallCommands
{
    ...
    public class CallControlRecordStartServiceTest : BaseTelnyxTest
    {
        ...
        private readonly CallControlRecordStartCreateOptions createOptions;
            ...
            : base(mockHttpClientFixture)
        {
            ...
            this.createOptions = new CallControlRecordStartCreateOptions()
            {
                ClientState = "aGF2ZSBhIG5pY2UgZGF5ID1d",
                CommandId = new System.Guid("891510ac-f3e4-11e8-af5b-de00688a4901"),
                Channel = CallControlRecordStartCreateOptions.ChannelEnum.DualEnum,
                Format = CallControlRecordStartCreateOptions.FormatEnum.Mp3Enum,
                PlayBeep = false
            };
        }
