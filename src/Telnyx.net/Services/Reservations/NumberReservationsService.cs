namespace Telnyx.net.Services.Reservations
{
        ...
        IRetrievable<NumberReservation>
    {
        ...
        /// <inheritdoc/>
        public async Task<NumberReservation> CreateAsync(NumberReservation createOptions, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc/>
        public async Task<NumberReservation> GetAsync(string id, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc/>
        public async Task<TelnyxList<NumberReservation>> ListAsync(NumberReservationsListOptions listOptions = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<NumberReservation> ExtendANumberReservationRequestAsync(string id, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
