namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, CallControlForkStartCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, CallControlForkStartCreateOptions createOptions, string postFix = "actions/fork_start", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
