namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, CallControlAnswerCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, CallControlAnswerCreateOptions createOptions, string postFix = "actions/answer", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
