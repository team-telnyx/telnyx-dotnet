namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, CallControlGatherUsingAudioCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, CallControlGatherUsingAudioCreateOptions createOptions, string postFix = "actions/gather_using_audio", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
