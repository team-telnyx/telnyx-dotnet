namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, CallControlGatherUsingSpeakCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, CallControlGatherUsingSpeakCreateOptions createOptions, string postFix = "actions/gather_using_speak", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
