namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, CallControlPlaybackStartCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, CallControlPlaybackStartCreateOptions createOptions, string postFix = "actions/playback_start", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
