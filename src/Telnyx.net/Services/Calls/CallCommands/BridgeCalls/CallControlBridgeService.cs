namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, CallControlBridgeCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, CallControlBridgeCreateOptions createOptions, string postFix = "actions/bridge", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
