namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, CallControlTransferCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, CallControlTransferCreateOptions createOptions, string postFix = "actions/transfer", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
