namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, CallControlSendDTMFCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, CallControlSendDTMFCreateOptions createOptions, string postFix = "actions/send_dtmf", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
