namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, CallControlRejectCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, CallControlRejectCreateOptions createOptions, string postFix = "actions/reject", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
