namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, JoinConferenceCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public async Task<CallAnswerResponse> CreateAsync(string parentId, JoinConferenceCreateOptions createOptions, string postFix = "actions/join", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
