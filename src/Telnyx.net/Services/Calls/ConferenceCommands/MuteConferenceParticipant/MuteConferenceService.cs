namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallAnswerResponse, MuteConferenceCreateOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallAnswerResponse> CreateAsync(string parentId, MuteConferenceCreateOptions createOptions, string postFix = "actions/mute", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
