namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallSpeakResponse, CallControlSpeakOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallSpeakResponse> CreateAsync(string parentId, CallControlSpeakOptions createOptions, string postFix = "actions/speak", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
