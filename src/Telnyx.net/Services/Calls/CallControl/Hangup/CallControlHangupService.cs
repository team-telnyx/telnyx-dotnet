namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallHangUpResponse, CallControlHangupOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallHangUpResponse> CreateAsync(string parentId, CallControlHangupOptions createOptions, string postFix = "actions/hangup", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
