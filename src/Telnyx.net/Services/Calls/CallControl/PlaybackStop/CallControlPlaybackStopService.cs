namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallPlaybackStopResponse, CallControlPlaybackStopOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallPlaybackStopResponse> CreateAsync(string parentId, CallControlPlaybackStopOptions createOptions, string postFix = "actions/playback_stop", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
