namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallRecordStartResponse, CallControlRecordStartOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallRecordStartResponse> CreateAsync(string parentId, CallControlRecordStartOptions createOptions, string postFix = "actions/record_start", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
