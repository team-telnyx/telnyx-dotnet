namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallSendDTMFResponse, CallControlSendDTMFOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallSendDTMFResponse> CreateAsync(string parentId, CallControlSendDTMFOptions createOptions, string postFix = "actions/send_dtmf", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
