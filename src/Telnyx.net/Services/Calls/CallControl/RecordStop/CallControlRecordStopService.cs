namespace Telnyx
{
        ...
        INestedCreatableWithIdInMid<CallRecordStopResponse, CallControlRecordStopOptions>
    {
        ...
        /// <inheritdoc/>
        public Task<CallRecordStopResponse> CreateAsync(string parentId, CallControlRecordStopOptions createOptions, string postFix = "actions/record_stop", RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
