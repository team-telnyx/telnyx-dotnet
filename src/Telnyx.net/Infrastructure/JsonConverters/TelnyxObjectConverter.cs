// <copyright file="TelnyxObjectConverter.cs" company="Telnyx">
...
namespace Telnyx.Infrastructure
{
    ...
    /// <summary>
    /// This converter can be used to deserialize any Telnyx object. It is mainly useful for
    ...
    /// </summary>
    public class TelnyxObjectConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            throw new NotSupportedException("TelnyxObjectConverter should only be used while deserializing.");
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            Type concreteType = TelnyxTypeRegistry.GetConcreteType(objectType, objectValue);
